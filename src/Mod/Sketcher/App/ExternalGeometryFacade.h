...
public:
    ...
    unsigned long getFlags() const override { return getExternalGeoExt()->getFlags(); }
    void setFlags(unsigned long flags) override { getExternalGeoExt()->setFlags(flags); }
    ...
    int getRefIndex() const override {return getExternalGeoExt()->getRefIndex();}
    void setRefIndex(int index) override {getExternalGeoExt()->setRefIndex(index);}
