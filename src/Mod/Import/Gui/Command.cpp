...
void FCCmdImportReadBREP::activated(int iMsg)
{
    ...
    QString fn = Gui::FileDialog::getOpenFileName(Gui::getMainWindow(), QString(), QString(), QStringLiteral("BREP (*.brep *.rle)"));
    if (fn.isEmpty()) {
        abortCommand();
        return;
    }
...
{
    Q_UNUSED(iMsg);
    QString fn = Gui::FileDialog::getOpenFileName(Gui::getMainWindow(), QString(), QString(), QStringLiteral("STEP (*.stp *.step)"));
    if (!fn.isEmpty()) {
...
{
    Q_UNUSED(iMsg);
    QString fn = Gui::FileDialog::getOpenFileName(Gui::getMainWindow(), QString(), QString(), QStringLiteral("IGES (*.igs *.iges)"));
    if (!fn.isEmpty()) {
