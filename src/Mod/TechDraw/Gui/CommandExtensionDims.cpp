...
Gui::Action* CmdTechDrawExtensionInsertPrefixGroup::createAction()
{
    ...
    p3->setObjectName(QStringLiteral("TechDraw_ExtensionRemovePrefixChar"));
    p3->setWhatsThis(QStringLiteral("TechDraw_ExtensionRemovePrefixChar"));
...
Gui::Action* CmdTechDrawExtensionPosChainDimensionGroup::createAction()
{
    ...
    p2->setWhatsThis(QStringLiteral("TechDraw_ExtensionPosVertChainDimension"));
    QAction* p3 = pcAction->addAction(QString());
