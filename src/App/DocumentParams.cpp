...
public:
    ...
    DocumentParamsP() {
        ...
        SaveThumbnail = handle->GetBool("SaveThumbnail", false);
        ...
        AddThumbnailLogo = handle->GetBool("AddThumbnailLogo", true);
        ...
        ThumbnailSize = handle->GetInt("ThumbnailSize", 128);
        ...
        HashIndexedName = handle->GetBool("HashIndexedName", false);
