 ...
 *
 * This class is auto generated by App/GroupParams.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r App/GroupParams.h App/GroupParams.cpp
 * @endcode
 *
 * You can add a new parameter by adding lines in App/GroupParams.py. Available
 ...
 * And you need to provide a function implementation in App/GroupParams.cpp with
...
public:
    ...
    static const bool & getCreateGroupInGroup();
    static const bool & defaultCreateGroupInGroup();
    static void removeCreateGroupInGroup();
    static void setCreateGroupInGroup(const bool &v);
