...
{
    QString value = QStringLiteral("'%1 %2'").arg(quantity.getValue(), 0, format.toFormat(), format.precision+2)
...
{
    QString number = QStringLiteral("%1").arg(value, 0, format.toFormat(), format.precision+1);
    return number;
}
