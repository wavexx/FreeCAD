...
void DlgDisplayPropertiesImp::on_checkBoxMapFaceColor_toggled(bool checked)
{
    onPropertyBoolChanged("MapFaceColor", checked);
}

void DlgDisplayPropertiesImp::on_checkBoxMapLineColor_toggled(bool checked)
{
    onPropertyBoolChanged("MapEdgeColor", checked);
}

void DlgDisplayPropertiesImp::on_checkBoxMapPointColor_toggled(bool checked)
{
    onPropertyBoolChanged("MapVertexColor", checked);
}

void DlgDisplayPropertiesImp::on_checkBoxMapTransparency_toggled(bool checked)
{
...
{
    setPropertyColor("ShapeColor", d->ui.buttonColor, views);
}

void DlgDisplayPropertiesImp::setLineColor(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyColor("LineColor", d->ui.buttonLineColor, views);
}

void DlgDisplayPropertiesImp::setPointColor(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyColor("PointColor", d->ui.buttonPointColor, views);
}

void DlgDisplayPropertiesImp::setPropertyColor(const char *name, Gui::ColorButton *button,
                                               const std::vector<Gui::ViewProvider*>& views)
{
    bool enable = false;
    for (std::vector<Gui::ViewProvider*>::const_iterator it = views.begin(); it != views.end(); ++it) {
        App::Property* prop = (*it)->getPropertyByName(name);
        if (prop && prop->getTypeId() == App::PropertyColor::getClassTypeId()) {
...
{
    setPropertyBool("MapFaceColor", d->ui.checkBoxMapFaceColor, views);
}

void DlgDisplayPropertiesImp::setMapEdgeColor(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyBool("MapEdgeColor", d->ui.checkBoxMapLineColor, views);
}

void DlgDisplayPropertiesImp::setMapVertexColor(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyBool("MapVertexColor", d->ui.checkBoxMapPointColor, views);
}

void DlgDisplayPropertiesImp::setMapTransparency(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyBool("MapTransparency", d->ui.checkBoxMapTransparency, views);
}

void DlgDisplayPropertiesImp::setPropertyBool(const char *name, QCheckBox *checkbox,
                                              const std::vector<Gui::ViewProvider*>& views)
{
    bool enable = false;
    for (std::vector<Gui::ViewProvider*>::const_iterator it = views.begin(); it != views.end(); ++it) {
        if (auto prop = Base::freecad_dynamic_cast<App::PropertyBool>((*it)->getPropertyByName(name))) {
...
{
    setPropertyFloat("PointSize", d->ui.spinPointSize, views);
}

void DlgDisplayPropertiesImp::setLineWidth(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyFloat("LineWidth", d->ui.spinLineWidth, views);
}

void DlgDisplayPropertiesImp::setPropertyFloat(const char *name, QDoubleSpinBox *spinBox,
                                               const std::vector<Gui::ViewProvider*>& views)
{
    bool enable = false;
    for (std::vector<Gui::ViewProvider*>::const_iterator it = views.begin(); it != views.end(); ++it) {
...
void DlgDisplayPropertiesImp::setPropertyInteger(const char *name, QSlider *slider, QSpinBox *spinBox,
                                                 const std::vector<Gui::ViewProvider*>& views)
{
    bool enable = false;
    for (std::vector<Gui::ViewProvider*>::const_iterator it = views.begin(); it != views.end(); ++it) {
...
{
    setPropertyInteger("Transparency", d->ui.horizontalSlider, d->ui.spinTransparency, views);
}

void DlgDisplayPropertiesImp::setLineTransparency(const std::vector<Gui::ViewProvider*>& views)
{
    setPropertyInteger("LineTransparency", d->ui.sliderLineTransparency, d->ui.spinTransparency, views);
}
