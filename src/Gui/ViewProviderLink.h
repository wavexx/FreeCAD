...
public:
    ...
    bool canReplaceObject(App::DocumentObject* oldValue, App::DocumentObject* newValue) override;
    int replaceObject(App::DocumentObject* oldValue, App::DocumentObject* newValue) override;
