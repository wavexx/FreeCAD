 ...
 *
 * This class is auto generated by ReportViewParams.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r ReportViewParams.h ReportViewParams.cpp
 * @endcode
 *
 * You can add a new parameter by adding lines in ReportViewParams.py. Available
 ...
 * And you need to provide a function implementation in ReportViewParams.cpp with
