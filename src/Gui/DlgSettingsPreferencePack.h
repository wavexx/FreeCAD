...
#ifndef GUI_DIALOG_DLGPREFERENCEPACK_H
#define GUI_DIALOG_DLGPREFERENCEPACK_H
...
namespace Gui {
namespace Dialog {
class Ui_DlgSettingsPreferencePack;
 ...
 *  \author Werner Mayer
 */
class DlgSettingsPreferencePack : public PreferencePage
{
    Q_OBJECT

public:
    explicit DlgSettingsPreferencePack( QWidget* parent = nullptr );
    ~DlgSettingsPreferencePack() override;
...
private:
    std::unique_ptr<Ui_DlgSettingsPreferencePack> ui;
...
#endif // GUI_DIALOG_DLGPREFERENCEPACK_H
