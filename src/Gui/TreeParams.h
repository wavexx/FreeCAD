 ...
 *
 * This class is auto generated by TreeParams.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r TreeParams.h Tree.cpp
 * @endcode
 *
 * You can add a new parameter by adding lines in TreeParams.py. Available
