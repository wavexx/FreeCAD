...
public:
    ...
    bool EnablePreselection; // Auto generated code. See class document of ViewParams.
    ...
    unsigned long HighlightColor; // Auto generated code. See class document of ViewParams.
    unsigned long SelectionColor; // Auto generated code. See class document of ViewParams.
    ...
    long ShowSelectionBoundingBoxThreshold; // Auto generated code. See class document of ViewParams.
    bool UpdateSelectionVisual; // Auto generated code. See class document of ViewParams.
    bool LinkChildrenDirect; // Auto generated code. See class document of ViewParams.
    bool ShowSelectionOnTop; // Auto generated code. See class document of ViewParams.
    bool ShowPreSelectedFaceOnTop; // Auto generated code. See class document of ViewParams.
    bool ShowPreSelectedFaceOutline; // Auto generated code. See class document of ViewParams.
    bool AutoTransparentPick; // Auto generated code. See class document of ViewParams.
    bool SelectElementOnTop; // Auto generated code. See class document of ViewParams.
    double TransparencyOnTop; // Auto generated code. See class document of ViewParams.
    bool HiddenLineSelectionOnTop; // Auto generated code. See class document of ViewParams.
    bool PartialHighlightOnFullSelect; // Auto generated code. See class document of ViewParams.
    double SelectionLineThicken; // Auto generated code. See class document of ViewParams.
    double SelectionLineMaxWidth; // Auto generated code. See class document of ViewParams.
    double SelectionPointScale; // Auto generated code. See class document of ViewParams.
    double SelectionPointMaxSize; // Auto generated code. See class document of ViewParams.
    double PickRadius; // Auto generated code. See class document of ViewParams.
    double SelectionTransparency; // Auto generated code. See class document of ViewParams.
    long SelectionLinePattern; // Auto generated code. See class document of ViewParams.
    long SelectionLinePatternScale; // Auto generated code. See class document of ViewParams.
    double SelectionHiddenLineWidth; // Auto generated code. See class document of ViewParams.
    double SelectionBBoxLineWidth; // Auto generated code. See class document of ViewParams.
    bool ShowHighlightEdgeOnly; // Auto generated code. See class document of ViewParams.
    double PreSelectionDelay; // Auto generated code. See class document of ViewParams.
    bool UseNewRayPick; // Auto generated code. See class document of ViewParams.
    double ViewSelectionExtendFactor; // Auto generated code. See class document of ViewParams.
    bool UseTightBoundingBox; // Auto generated code. See class document of ViewParams.
    bool UseBoundingBoxCache; // Auto generated code. See class document of ViewParams.
    bool RenderProjectedBBox; // Auto generated code. See class document of ViewParams.
    ...
    long DockOverlayRevealDelay; // Auto generated code. See class document of ViewParams.
    long DockOverlaySplitterHandleTimeout; // Auto generated code. See class document of ViewParams.
    bool DockOverlayActivateOnHover; // Auto generated code. See class document of ViewParams.
    bool DockOverlayAutoMouseThrough; // Auto generated code. See class document of ViewParams.
    bool DockOverlayWheelPassThrough; // Auto generated code. See class document of ViewParams.
    long DockOverlayWheelDelay; // Auto generated code. See class document of ViewParams.
    long DockOverlayAlphaRadius; // Auto generated code. See class document of ViewParams.
    bool DockOverlayCheckNaviCube; // Auto generated code. See class document of ViewParams.
    long DockOverlayHintTriggerSize; // Auto generated code. See class document of ViewParams.
    long DockOverlayHintSize; // Auto generated code. See class document of ViewParams.
    bool DockOverlayHintTabBar; // Auto generated code. See class document of ViewParams.
    bool DockOverlayHideTabBar; // Auto generated code. See class document of ViewParams.
    long DockOverlayHintDelay; // Auto generated code. See class document of ViewParams.
    long DockOverlayAnimationDuration; // Auto generated code. See class document of ViewParams.
    long DockOverlayAnimationCurve; // Auto generated code. See class document of ViewParams.
    bool DockOverlayHidePropertyViewScrollBar; // Auto generated code. See class document of ViewParams.
    double EditingTransparency; // Auto generated code. See class document of ViewParams.
    double HiddenLineTransparency; // Auto generated code. See class document of ViewParams.
    bool HiddenLineOverrideTransparency; // Auto generated code. See class document of ViewParams.
    unsigned long HiddenLineFaceColor; // Auto generated code. See class document of ViewParams.
    bool HiddenLineOverrideFaceColor; // Auto generated code. See class document of ViewParams.
    unsigned long HiddenLineColor; // Auto generated code. See class document of ViewParams.
    bool HiddenLineOverrideColor; // Auto generated code. See class document of ViewParams.
    unsigned long HiddenLineBackground; // Auto generated code. See class document of ViewParams.
    bool HiddenLineOverrideBackground; // Auto generated code. See class document of ViewParams.
    bool HiddenLineShaded; // Auto generated code. See class document of ViewParams.
    bool HiddenLineShowOutline; // Auto generated code. See class document of ViewParams.
    bool HiddenLinePerFaceOutline; // Auto generated code. See class document of ViewParams.
    double HiddenLineWidth; // Auto generated code. See class document of ViewParams.
    double HiddenLinePointSize; // Auto generated code. See class document of ViewParams.
    bool HiddenLineHideSeam; // Auto generated code. See class document of ViewParams.
    bool HiddenLineHideVertex; // Auto generated code. See class document of ViewParams.
    bool HiddenLineHideFace; // Auto generated code. See class document of ViewParams.
    long StatusMessageTimeout; // Auto generated code. See class document of ViewParams.
    bool ShadowFlatLines; // Auto generated code. See class document of ViewParams.
    long ShadowDisplayMode; // Auto generated code. See class document of ViewParams.
    bool ShadowSpotLight; // Auto generated code. See class document of ViewParams.
    double ShadowLightIntensity; // Auto generated code. See class document of ViewParams.
    double ShadowLightDirectionX; // Auto generated code. See class document of ViewParams.
    double ShadowLightDirectionY; // Auto generated code. See class document of ViewParams.
    double ShadowLightDirectionZ; // Auto generated code. See class document of ViewParams.
    unsigned long ShadowLightColor; // Auto generated code. See class document of ViewParams.
    bool ShadowShowGround; // Auto generated code. See class document of ViewParams.
    bool ShadowGroundBackFaceCull; // Auto generated code. See class document of ViewParams.
    double ShadowGroundScale; // Auto generated code. See class document of ViewParams.
    unsigned long ShadowGroundColor; // Auto generated code. See class document of ViewParams.
    std::string ShadowGroundBumpMap; // Auto generated code. See class document of ViewParams.
    std::string ShadowGroundTexture; // Auto generated code. See class document of ViewParams.
    double ShadowGroundTextureSize; // Auto generated code. See class document of ViewParams.
    double ShadowGroundTransparency; // Auto generated code. See class document of ViewParams.
    bool ShadowGroundShading; // Auto generated code. See class document of ViewParams.
    bool ShadowExtraRedraw; // Auto generated code. See class document of ViewParams.
    long ShadowSmoothBorder; // Auto generated code. See class document of ViewParams.
    long ShadowSpreadSize; // Auto generated code. See class document of ViewParams.
    long ShadowSpreadSampleSize; // Auto generated code. See class document of ViewParams.
    double ShadowPrecision; // Auto generated code. See class document of ViewParams.
    double ShadowEpsilon; // Auto generated code. See class document of ViewParams.
    double ShadowThreshold; // Auto generated code. See class document of ViewParams.
    double ShadowBoundBoxScale; // Auto generated code. See class document of ViewParams.
    double ShadowMaxDistance; // Auto generated code. See class document of ViewParams.
    bool ShadowTransparentShadow; // Auto generated code. See class document of ViewParams.
    bool ShadowUpdateGround; // Auto generated code. See class document of ViewParams.
    unsigned long PropertyViewTimer; // Auto generated code. See class document of ViewParams.
    bool HierarchyAscend; // Auto generated code. See class document of ViewParams.
    long CommandHistorySize; // Auto generated code. See class document of ViewParams.
    long PieMenuIconSize; // Auto generated code. See class document of ViewParams.
    long PieMenuRadius; // Auto generated code. See class document of ViewParams.
    long PieMenuTriggerRadius; // Auto generated code. See class document of ViewParams.
    long PieMenuFontSize; // Auto generated code. See class document of ViewParams.
    long PieMenuTriggerDelay; // Auto generated code. See class document of ViewParams.
    bool PieMenuTriggerAction; // Auto generated code. See class document of ViewParams.
    long PieMenuAnimationDuration; // Auto generated code. See class document of ViewParams.
    long PieMenuAnimationCurve; // Auto generated code. See class document of ViewParams.
    long PieMenuCenterRadius; // Auto generated code. See class document of ViewParams.
    bool PieMenuPopup; // Auto generated code. See class document of ViewParams.
    bool StickyTaskControl; // Auto generated code. See class document of ViewParams.
    bool ColorOnTop; // Auto generated code. See class document of ViewParams.
    bool ColorRecompute; // Auto generated code. See class document of ViewParams.
    bool AutoSortWBList; // Auto generated code. See class document of ViewParams.
    long MaxCameraAnimatePeriod; // Auto generated code. See class document of ViewParams.
    bool TaskNoWheelFocus; // Auto generated code. See class document of ViewParams.
    bool GestureLongPressRotationCenter; // Auto generated code. See class document of ViewParams.
    bool CheckWidgetPlacementOnRestore; // Auto generated code. See class document of ViewParams.
    long TextCursorWidth; // Auto generated code. See class document of ViewParams.
    long PreselectionToolTipCorner; // Auto generated code. See class document of ViewParams.
    long PreselectionToolTipOffsetX; // Auto generated code. See class document of ViewParams.
    long PreselectionToolTipOffsetY; // Auto generated code. See class document of ViewParams.
    long PreselectionToolTipFontSize; // Auto generated code. See class document of ViewParams.
    bool SectionFill; // Auto generated code. See class document of ViewParams.
    bool SectionFillInvert; // Auto generated code. See class document of ViewParams.
    bool SectionConcave; // Auto generated code. See class document of ViewParams.
    bool NoSectionOnTop; // Auto generated code. See class document of ViewParams.
    double SectionHatchTextureScale; // Auto generated code. See class document of ViewParams.
    std::string SectionHatchTexture; // Auto generated code. See class document of ViewParams.
    bool SectionHatchTextureEnable; // Auto generated code. See class document of ViewParams.
    bool SectionFillGroup; // Auto generated code. See class document of ViewParams.
    bool ShowClipPlane; // Auto generated code. See class document of ViewParams.
    double ClipPlaneSize; // Auto generated code. See class document of ViewParams.
    std::string ClipPlaneColor; // Auto generated code. See class document of ViewParams.
    double ClipPlaneLineWidth; // Auto generated code. See class document of ViewParams.
    bool TransformOnTop; // Auto generated code. See class document of ViewParams.
    double SelectionColorDifference; // Auto generated code. See class document of ViewParams.
    long RenderCacheMergeCount; // Auto generated code. See class document of ViewParams.
    long RenderCacheMergeCountMin; // Auto generated code. See class document of ViewParams.
    long RenderCacheMergeCountMax; // Auto generated code. See class document of ViewParams.
    long RenderCacheMergeDepthMax; // Auto generated code. See class document of ViewParams.
    long RenderCacheMergeDepthMin; // Auto generated code. See class document of ViewParams.
    bool ForceSolidSingleSideLighting; // Auto generated code. See class document of ViewParams.
    long DefaultFontSize; // Auto generated code. See class document of ViewParams.
    bool EnableTaskPanelKeyTranslate; // Auto generated code. See class document of ViewParams.
    bool EnableMenuBarCheckBox; // Auto generated code. See class document of ViewParams.
    bool EnableBacklight; // Auto generated code. See class document of ViewParams.
